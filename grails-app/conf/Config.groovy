...
log4j.main = {
    ...
    off 'org.gametube.redisflexiblecache.RedisFlexibleCacheService'
    debug additivity: false, stdout: ['grails.app.services', 'grails.app.controllers', 'grails.app.domain']
...
grails {  // example of configuration
    redis {
        ...
        port = 6379
        host = 'canarydev.redis.cache.windows.net'
        timeout = 2000 // default in milliseconds
        password = 'ump87BazjpiiY7i9eYTsvzVJXj2sQ8FE7c5+Si7zkOo=' // defaults to no password
        useSSL = true
        connections {
            cache {
                //enabled = false // cache enabled by default
                database = 1
                host = 'canarydev.redis.cache.windows.net'  // will override the base one
                password = 'ump87BazjpiiY7i9eYTsvzVJXj2sQ8FE7c5+Si7zkOo=' // defaults to no password
